...
const updateSyncTool = (leftItem, rightItem, activeIndex) => {
  ...
  if (!leftItem.getCursorScreenPosition || !leftItem.getCursorBufferPosition) return
  if (!rightItem.getCursorScreenPosition || !rightItem.getCursorBufferPosition) return
